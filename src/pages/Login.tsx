  ...
  return (
    <div className='w-full bg-[#071933] pt-[50px] pb-[280px]'>
      ...
      <form className='w-[538px] mt-[50px] mx-auto'>
        ...
        <button type='submit' className='block w-[254px] h-[40px] mx-auto font-Open Sans font-sans text-[16px] font-semibold text-white bg-[#1e70eb] rounded-[10px]'>Увійти</button>
      </form>
