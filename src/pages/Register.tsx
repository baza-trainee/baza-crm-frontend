...
const Register = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.agree) {
      alert(
        'Ви повинні погодитися з Правилами користування та Політикою конфіденційності!',
      );
      return;
    }
  ...
  return (
    <div className="w-full bg-[#071933] pt-[50px] pb-[198px]">
      ...
      <div className="w-[891px] text-center pt-[50px] mx-auto">
        <h1 className="font-Lato font-sans text-[40px] text-white">
          Реєстрація учасника в CRM системі на Baza Trainee Ukraine
        </h1>
      </div>
